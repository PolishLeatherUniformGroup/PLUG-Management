...
export class QueryController {
    ...
    @ApiResponse({ status: 200, description: 'Recommendations', type: RecommendationsDto })
    @ApiParam({ name: 'id', required: true, description: 'Applicant Id', type: 'string' })
    async getApplicationRecommendations(@Param() id: string): Promise<RecommendationsDto> {
