...
export class Applicant extends AggregateRoot {
  ...
  public registerFeePayment(paidFee: Money, paidDate: Date) {
    this.apply(
      new ApplicantPaidFee(this._applicantId.value, paidDate, paidFee),
    );
  }

  public confirmRecommendation(recommendationId: string) {
    this.apply(
      new ApplicantRecommendationConfirmed(
        this._applicantId.value,
        recommendationId,
      ),
    );
  ...
  public refuseRecommendation(recommendationId: string) {
    this.apply(
      new ApplicantRecommendationRefused(
        this._applicantId.value,
        recommendationId,
      ),
    );
  ...
  public appealApplicationRejection(date: Date, justification: string) {
    ...
    if (this._appealDeadline && date > this._appealDeadline) {
      this.apply(
        new ApplicantRejectionAppealCancelled(
          this._applicantId.value,
          date,
          justification,
        ),
      ...
      this.apply(
        new ApplicantRejectionAppealReceived(
          this._applicantId.value,
          date,
          justification,
        ),
  ...
  public acceptApplicationRejectionAppeal(date: Date, decision: string) {
    ...
    this.apply(
      new ApplicantRejectionAppealAccepted(
        this._applicantId.value,
        date,
        decision,
      ),
  ...
  public rejectApplicationRejectionAppeal(date: Date, decision: string) {
    ...
    this.apply(
      new ApplicantRejectionAppealRejected(
        this._applicantId.value,
        date,
        decision,
      ),
  ...
  private onApplicantRecommendationConfirmed(
    event: ApplicantRecommendationConfirmed,
  ) {
  ...
  private onApplicantRecommendationRefused(
  ...
  private onApplicantRejectionAppealCancelled(
  ...
  private onApplicantRejectionAppealReceived(
  ...
  private onApplicantRejectionAppealAccepted(
  ...
  private onApplicantRejectionAppealRejected(
