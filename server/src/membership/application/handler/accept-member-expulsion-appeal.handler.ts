...
export class AcceptMemberExpulsionAppealHandler implements ICommandHandler<AcceptMemberExpulsionAppealCommand> {
    constructor(
    ...
    async execute(command: AcceptMemberExpulsionAppealCommand) {
        ...
        member.acceptExpulsionAppeal(command.expulsionId, command.date, command.reason);
