...
export class RejectMemberExpulsionAppealHandler implements ICommandHandler<RejectMemberExpulsionAppealCommand> {
    constructor(
    ...
    async execute(command: RejectMemberExpulsionAppealCommand) {
        ...
        member.rejectExpulsionAppeal(command.expulsionId, command.date, command.reason);
