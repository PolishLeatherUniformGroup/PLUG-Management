...
export class RejectMemberSuspensionAppealHandler implements ICommandHandler<RejectMemberSuspensionAppealCommand> {
    constructor(
    ...
    async execute(command: RejectMemberSuspensionAppealCommand) {
        ...
        member.rejectSuspensionAppeal(command.suspensionId, command.date, command.reason);
