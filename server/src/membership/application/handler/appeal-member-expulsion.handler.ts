...
export class AppealMemberExpulsionHandler implements ICommandHandler<AppealMemberExpulsionCommand> {
    constructor(
    ...
    async execute(command: AppealMemberExpulsionCommand) {
        ...
        member.appealExpulsion(command.expulsionId, command.appealDate, command.justification);
