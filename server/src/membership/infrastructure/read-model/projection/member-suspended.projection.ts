...
export class MemberSuspendedProjection  implements IEventHandler<MemberSuspended>{
    constructor(
        @InjectRepository(MemberView) private memberViewRepository: Repository<MemberView>,
        @InjectRepository(MemberSuspensionView) private memberSuspensionViewRepository: Repository<MemberSuspensionView>
    ) {}
