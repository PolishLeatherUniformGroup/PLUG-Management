...
import { MembershipSuspensionAppealRejected } from '../../../domain/events';
...
export class MemberSuspensionAppealRejectedProjection
  implements IEventHandler<MembershipSuspensionAppealRejected>
{
  constructor(
