...
import { MemberExpulsionAppealed, MembershipSuspensionAppealed } from "src/membership/domain/events";
...
export class MemberExpulsionAppealedProjection implements IEventHandler<MemberExpulsionAppealed> {
    constructor(
