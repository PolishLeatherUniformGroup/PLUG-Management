...
export class SuspendMemberHandler implements ICommandHandler<SuspendMemberCommand> {
    constructor(
    ...
    async execute(command: SuspendMemberCommand) {
        ...
        member.suspend(command.suspensionDate, command.suspendUntil, command.suspensionReason, command.appealDeadline);
